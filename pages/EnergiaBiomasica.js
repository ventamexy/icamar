      ...
      <div className="about-box-main">
        <div className="container">
          <h2 className="noo-sh-title">
            <span>¿Qué es la energía biomásica y cómo se puede aprovechar?</span>
          </h2>
          <div className="row">
            <div className="col-lg-12">
              <div className="banner-frame">
                <img
                  ...
                  src="https://www.foronuclear.org/wp-content/uploads/2010/06/biomasa-854x465.jpg"
                  alt=""
                  width="1000"
            ...
            <div className="col-lg-12">
              ...
              <p>
                La energía de la biomasa se puede conseguir fundamentalmente:{" "}<br />
                <ul>
                  <li>
                    1.{" "}Estableciendo determinados cultivos vegetales que puedan transformarse posteriormente en energía (biomasa cosechable).
                  </li>
                  <li>
                    2.{" "}Aprovechando residuos forestales, agrícolas y domésticos, transformándolos en combustible (biomasa residual).
                  </li>
                  <li>
                    3.{" "}Transformando química o biológicamente ciertas especies vegetales para convertirlas también en combustible (metanol y etanol).
                  </li>
                </ul>
              </p>
              <h2>
                La biomasa es la energía que se puede obtener de los compuestos orgánicos formados en procesos naturales
              </h2>
              <p>
